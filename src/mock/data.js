...
export const projectsData = [
  ...
  },
  {
    ...
    info2:
      'As a design of three, we did the 1)Overview - this was an app to help improve the scheduling of students studylife  2) Analysing user data - we analised ourselves and classmates on what was their problems 3) Creating personas - we assumed, that they were all students some looking for classes to fill their schedule  4) Ideation - we figured that by research planning it around a calendar would be the best option 5) Creating storyboards - we had two scenarios where students and freetime and wanted to put some class in. ',
